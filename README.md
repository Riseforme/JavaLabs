<h2>Шаг 1. Создание массива транзакций</h2>
...
```
<h2>Шаг 2. Реализация функций для анализа транзакций</h2>
...
<h2>Шаг 3. Тестирование функций</h2>
...
Какие методы массивов можно использовать для обработки объектов в JavaScript? - map, filter, reduce, some, every <br>
Как сравнивать даты в строковом формате в JavaScript? - выполнить разделение на день/месяц/год с помощью split() или же преобразовать в объект Date <br>
В чем разница между map(), filter() и reduce() при работе с массивами объектов? Map возвращает массив преобразованных значений; filter выбирает из массива только элементы, подходящие под условие; reduce возвращает одно значение, полученное в результате работы со всемы элементами массива
